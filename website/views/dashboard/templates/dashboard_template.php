...
class dashboardTemplate
{
    ...
    public static function dashEnd()
    {
        echo ('</div>
            ...
            <script src="resources/js/vendor/dropzone.js"></script>
            </html>');
    }
                ...
                <nav class="container-fluid position-absolute navbar navbar--main bg-white shadow-sm">
                        <div class="container">
                            ...
                            <ul class="navbar__links navbar__icons">
                                <li><a href="user.php"><img src="resources/img/cuenta.svg"></a></li>
                                <li><a href="index.php"><img src="resources/img/logout.svg"></a></li>
                            </ul>
                        </div>
                    </nav>
            </header>');
